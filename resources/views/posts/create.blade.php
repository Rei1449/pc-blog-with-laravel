            ...
            <div class='p-4 sm:p-8 bg-white shadow sm:rounded-lg'>
                <form action="/posts" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <img id="imagePreview" alt="プレビュー画像" style="display:none; max-width: 200px; max-height: 200px;">
                    </div>
                    <div class="xl:flex">
                        <div class="flex-none sm:flex sm:justify-between">
                            <div class="p-4 mb-2 bg-gray-50 shadow sm:rounded-lg sm:m-0 lg:m-0 xl:m-0">
                                <div>osを選択してください <i class="fa-solid fa-desktop"></i></i><span class="text-red-600">*</span></div>
                                <input type="radio" name="post[os]" value="Mac" id="mac" {{ old("post.os") === "Mac" ? "checked": "" }}>
                                <label for="option1">Mac</label>
                                <input type="radio" name="post[os]" value="Windows" id="Windows" {{ old("post.os") === "Windows" ? "checked" : "" }}>
                            ...
                            <div class='p-4 mb-2 bg-gray-50 shadow sm:rounded-lg sm:m-0 lg:mr-28 xl:m-0'>
                                ...
                                <input type="radio" name="post[cost]" value="8万円以下" id="cost1" {{ old("post.cost") === "8万円以下" ? "checked": "" }}>
                                <label for="option1">8万円以下</label>
                                <input type="radio" name="post[cost]" value="8万円~12万円" id="cost2" {{ old("post.cost") === "8万円~12万円" ? "checked": "" }}>
                                <label for="option2">8~12万円</label>
                                <input type="radio" name="post[cost]" value="12万円以上" id="cost3" {{ old("post.cost") === "12万円以上" ? "checked": "" }}>
                        ...
                        <div class='flex-none sm:flex sm:justify-between'>
                            <div class='p-4 mb-2 bg-gray-50 shadow sm:rounded-lg sm:m-0 lg:m-0 xl:m-0'>
                                ...
                                <input type="radio" name="post[weight]" value="1.5kg以下" id="weight1" {{ old("post.weight") === "1.5kg以下" ? "checked": "" }}>
                                <label for="option1">1.5kg以下</label>
                                <input type="radio" name="post[weight]" value="1.5~2kg" id="weight2" {{ old("post.weight") === "1.5~2kg" ? "checked": "" }}>
                                <label for="option2">1.5~2kg</label>
                                <input type="radio" name="post[weight]" value="2kg以上" id="weight3" {{ old("post.weight") === "2kg以上" ? "checked": "" }}>
                            ...
                            <div class='p-4 mb-2 bg-gray-50 shadow sm:rounded-lg sm:m-0 lg:mr-28 xl:m-0'>
                                ...
                                <input type="radio" name="post[battery]" value="3時間以下" id="battery1" {{ old("post.battery") === "3時間以下" ? "checked": "" }}>
                                <label for="option1">3時間以下</label>
                                <input type="radio" name="post[battery]" value="3時間~6時間" id="battery2" {{ old("post.battery") === "3時間~6時間" ? "checked": "" }}>
                                <label for="option2">3時間~6時間</label>
                                <input type="radio" name="post[battery]" value="6時間以上" id="battery3" {{ old("post.battery") === "6時間以上" ? "checked": "" }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="post[purchase_path]" class="w-full" placeholder="PCが購入できるURLを入れてください(公式サイト、Amazonなど)" value="{{ old('post.purchase_path') }}"/>
                    </div>
                    <div class="flex justify-center sm:justify-start">
                        <div class='p-4 my-2 bg-gray-100 shadow sm:rounded-lg w-custom'>
                            ...
                            <input type="radio" name="post[star_rating]" value="1" id="star_rating1" {{ old("post.star_rating") === "1" ? "checked": "" }}>
                            <label for="option1"><i class="text-yellow-400 fa-solid fa-star"></i><span class ="mr-2">1</span></label>
                            <input type="radio" name="post[star_rating]" value="2" id="star_rating2" {{ old("post.star_rating") === "2" ? "checked": "" }}>
                            <label for="option2"><i class="text-yellow-400 fa-solid fa-star"></i><span class ="mr-2">2</span></label>
                            <input type="radio" name="post[star_rating]" value="3" id="star_rating3" {{ old("post.star_rating") === "3" ? "checked": "" }}>
                            <label for="option3"><i class="text-yellow-400 fa-solid fa-star"></i><span class ="mr-2">3</span></label>
                            <input type="radio" name="post[star_rating]" value="4" id="star_rating4" {{ old("post.star_rating") === "4" ? "checked": "" }}>
                            <label for="option4"><i class="text-yellow-400 fa-solid fa-star"></i><span class ="mr-2">4</span></label>
                            <input type="radio" name="post[star_rating]" value="5" id="star_rating5" {{ old("post.star_rating") === "5" ? "checked": "" }}>
